...
For full signatures, types, and examples, see the [API Reference](${CLAUDE_SKILL_DIR}/references/api.md).

## Integration Patterns

For detailed code examples of each pattern, see [Patterns Reference](${CLAUDE_SKILL_DIR}/references/patterns.md). Here's when to reach for each:
...
The [Patterns Reference](${CLAUDE_SKILL_DIR}/references/patterns.md) also covers creative patterns from the community:
